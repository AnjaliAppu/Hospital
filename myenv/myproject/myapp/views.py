...
from.forms import PatientForm,LoginForm,DoctorForm,AccountForm,AppointmentForm,DiseaseForm,DepartmentForm
from .models import Patient,Doctor,Login,AdminMaster,PatientAppointment,DiseaseList,DepartmentSection
...
def viewdiease(request):
    result = DiseaseList.objects.all()
    return render(request,'viewdiease.html',{'result':result})
